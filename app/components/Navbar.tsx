...
function Navbar() {
  ...
  return (
    <header className = { isOpen?` transition-all duration-300 ease-in-out bg-sky-950 md:sticky top-0 z-10 text-white ` : ` text-white transition-all duration-300 ease-in-out md:bg-gray-900 md:sticky top-0 z-10`}>
        <div className=" transition-all duration-300 ease-in-out  container mx-auto flex flex-wrap p-3 flex-col md:flex-row justify-between items-center md:justify-start">
        ...
        <nav  className={isOpen? ` ease-in-out w-full md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-600	flex flex-wrap flex-col md:flex-row items-start text-base justify-start  ` :
                                 ` hidden md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-600	md:flex flex-wrap items-center text-base justify-center`}>
        ...
        <div className={isOpen?` w-full flex flex-col items-start justify-start p-3 md:mr-5`:`hidden md:flex  items-center justify-center mr-5`} onClick={()=>setIsClick(!isClick)} >
          ...
          {isClick? 
            <div className={isOpen? `w-full flex flex-col md:flex-row items-start md:m-2 md:gap-1 `:`hidden md:flex gap-5 mr-4 `}>
