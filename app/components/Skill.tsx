  ...
  return (
    ...
    <div className="container px-5 py-10 mx-auto">
      <div className=" flex flex-col  items-center text-center mb-20">
        ...
        <motion.h1 initial={{opacity:0 ,x:-10}} transition={{delay:.6}} whileInView={{opacity:1,x:1}} className="sm:text-4xl text-3xl font-medium title-font text-white mb-4">
          Skills &amp; Technologies
        </motion.h1>
        <motion.p initial={{opacity:0 ,x:10}} transition={{delay:.7}} whileInView={{opacity:1,y:1}} className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">
